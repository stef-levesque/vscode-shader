...
let documentSelector = [
    ...
    { language: 'shaderlab', scheme: 'file' },
...
export class SessionManager {
    ...
    private startEditorServices() {
        try
        {
            ...
            var serverExe = path.resolve(__dirname, '..', 'bin', 'ShaderTools.LanguageServer.dll');
            ...
            let clientOptions: LanguageClientOptions = {
                ...
                synchronize: {
                    ...
                    fileEvents: [
                        ...
                        vscode.workspace.createFileSystemWatcher('**/*.shaderlab')
                    ]
                },
            }
